...
class ProjectCommentsControllerTest < ActionController::TestCase
  ...
  test "should create project_comment" do
    assert_difference('ProjectComment.count') do
      post :create, project_comment: { ProjectPost_id: @project_comment.ProjectPost_id, text: @project_comment.text, user_id: @project_comment.user_id }
    end
  ...
  test "should update project_comment" do
    patch :update, id: @project_comment, project_comment: { ProjectPost_id: @project_comment.ProjectPost_id, text: @project_comment.text, user_id: @project_comment.user_id }
    assert_redirected_to project_comment_path(assigns(:project_comment))
  end
